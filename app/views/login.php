                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <!-- <div class="row g-0"> -->
                            <!-- <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="IMG/pexels-photo-6781340.jpeg" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; height:100%;" />
                            </div> -->
                            <div class="col-md-6 col-lg-7 w-100 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <div class="d-flex align-items-center mb-3 pb-1">
                                        ...
                                        <span class="h1 fw-bold mb-0">HEY</span>
                                    </div>
                                    ...
                                    <div class="pt-1 mb-4">
                                    <button class="btn btn-dark btn-lg btn-block btn-red">Login</button>
